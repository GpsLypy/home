...
int main(int argc,char *argv[],char *envp[])
{
  if (argc!=4)
  {
    ...
    printf("/htidc/shqx/bin/crtsurfdat 站点参数 数据文件存放的目录 日志文件名\n");
    printf("例如：/htidc/shqx/bin/crtsurfdat /htidc/shqx/ini/stcode.ini /data/shqx/ftp/surfdata /log/shqx/crtsurfdata.log\n");
    return -1;
  }
...
bool CrtSurfFile(const char *outpath)
{
  ...
  SNPRINTF(strFileName,300,300,"%s/SURF_ZH_%s_%d.txt",outpath,strLocalTime,getpid());
