...
int main(int argc,char *argv[])
{
  if (argc!=7)
  {
    ...
    printf("例如：/htidc/shqx/bin/pzhrain24file /log/shqx/pzhrain24file.log girla/girlpwdaa@Tencent11g_49.232.185.49 /data/wfile/zhrain24 /qxfile/zhrain24 T_ZHRAIN24 30\n");
